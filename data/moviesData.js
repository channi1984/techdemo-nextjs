const movies = [
    ...
    {
        id: "2",
        title: "Another Action Movie", // 구분을 위해 제목 살짝 수정
        imageUrl: "/images/img-movie.png",
        imageDetailUrl: "/images/img-movie-detail.png",
    ...
    {
        id: "4",
        title: "Romantic Comedy", // 구분을 위해 제목 수정
        imageUrl: "/images/img-movie.png",
        imageDetailUrl: "/images/img-movie-detail.png",
        description: "A heartwarming story of love and laughter.",
        rating: 4.0,
        genre: "Romance", // <-- 여기에 장르 추가
        actors: [
    ...
    {
        id: "6",
        title: "Deep Emotional Drama", // 구분을 위해 제목 수정
        imageUrl: "/images/img-movie.png",
        imageDetailUrl: "/images/img-movie-detail.png",
    ...
    // 더미 데이터를 추가할 때마다 genre 속성을 추가해주세요.
    {
        id: "7",
